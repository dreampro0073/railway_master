    ...
    <div class="container">
        <div class="row justify-content-center" >
            ...
            <div class="col-md-6 col-md-offset-3 login-box">
                <div>
                    <span style="font-size: 18px;font-weight: bold;font-style: italic;margin-bottom: 2px;text-align: center;display: block;">Railway Master</span> 
